...
| [M17](M17-place-and-compare.md) | Unplaced shot markers and the diagram/photo compare slider | optional · receive analysis | M13 | opus · high | opus · high | no | blocked: REV-33 'off target': is a round that hit outside the scoring area excluded from |
