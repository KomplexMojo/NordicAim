...
/** Defaults name to `Session <sessionDate>` per analysis-pipeline §1 when not given. */
...
/** Cascade delete: session, its photos, their analyses, and every `photo:<pid>:*` / `diagram:<pid>:*` /
 * `artifact:<aid>:*` blob. */
