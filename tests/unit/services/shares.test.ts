...
const ARTIFACT_META = { id: ARTIFACT_ID, sha256: 'a'.repeat(64), widthPx: 1440, heightPx: 2160, createdAt: '2026-09-05T17:20:00.000Z', rendererVersion: 3, scoringRule: 'gauge' as const, identity: '' };
